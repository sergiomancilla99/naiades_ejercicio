                ...
                <form>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" name="apellido" value="" maxlength="100">
                        </div>
...
form.addEventListener('submit', function(ev) {
    ev.preventDefault();
    let usuario = new FormData(form);
    let message = document.querySelector('span');

    fetch("ax/formulario.php", {
        method: "POST",
        body: usuario
    })
    ...
    .then( rta => {
        ...
        if(!rta.success) {
            message.innerText = "Los campos no pueden estar vacios";
        } else {
